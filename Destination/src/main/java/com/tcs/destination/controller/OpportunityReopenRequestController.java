...
public class OpportunityReopenRequestController {

	private static final Logger logger = LoggerFactory
			.getLogger(OpportunityReopenRequestController.class);
	...
	public @ResponseBody String findAll(
		...
		List<OpportunityReopenRequestT> opportunityReopenRequestTs = opportunityReopenRequestService.findAll();

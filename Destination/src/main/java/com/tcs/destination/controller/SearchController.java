...
public class SearchController {
	...
	@RequestMapping(value = "/CustPart/{typed}", method = RequestMethod.GET)
	public @ResponseBody List<CustPartResultCard> search(
			@PathVariable("typed") String typed) {
		return searchService.searchforCustPartDetail(typed);
	}
	...
	// }
	//
	// @RequestMapping(value = "/oppurtunity/{typed}", method =
	// RequestMethod.GET)

...
import static com.tcs.destination.enums.RequestType.PARTNER_DOWNLOAD;
...
@Component("partnerDwldPreprocessor")
public class PartnerDwldPreprocessor implements Tasklet{
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		if (requestList == null) {
			requestList = dataProcessingRequestRepository.findByRequestTypeAndStatus(PARTNER_DOWNLOAD.getType(), SUBMITTED.getStatus());
		}

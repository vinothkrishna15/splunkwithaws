...
import static com.tcs.destination.enums.JobStep.PRODUCT_CONTACT_UPLOAD_PROCESSING;
import static com.tcs.destination.enums.JobStep.END;
import static com.tcs.destination.enums.RequestStatus.VERIFIED;
import static com.tcs.destination.enums.RequestType.PRODUCT_CONTACT_UPLOAD;
 ...
 *
 */
@Component("productContactUploadPreprocessor")
public class ProductContactUploadPreprocessor implements Tasklet {

	private static final Logger logger = LoggerFactory
			.getLogger(ProductContactUploadPreprocessor.class);
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		if (requestList == null) {
			requestList = dataProcessingRequestRepository
					.findByRequestTypeAndStatus(
							PRODUCT_CONTACT_UPLOAD.getType(),
							VERIFIED.getStatus());
		}
		...
		if (CollectionUtils.isNotEmpty(requestList)) {
			...
			jobContext.put(NEXT_STEP, PRODUCT_CONTACT_UPLOAD_PROCESSING);

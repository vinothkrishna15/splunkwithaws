...
import static com.tcs.destination.enums.JobStep.CUSTOMER_ASSOCIATE_UPLOAD_PROCESSING;
import static com.tcs.destination.enums.RequestStatus.VERIFIED;
import static com.tcs.destination.enums.RequestType.CUSTOMER_ASSOCIATE_UPLOAD;
...
@Component("customerAssociateUploadPreprocessor")
public class CustomerAssociateUploadPreprocessor implements Tasklet {

	private static final Logger logger = LoggerFactory
			.getLogger(CustomerAssociateUploadPreprocessor.class);
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		if (requestList == null) {
			requestList = dataProcessingRequestRepository.findByRequestTypeAndStatus(CUSTOMER_ASSOCIATE_UPLOAD.getType(), VERIFIED.getStatus());
		}
		...
		if (CollectionUtils.isNotEmpty(requestList)) {
		    ...
		    jobContext.put(NEXT_STEP, CUSTOMER_ASSOCIATE_UPLOAD_PROCESSING);

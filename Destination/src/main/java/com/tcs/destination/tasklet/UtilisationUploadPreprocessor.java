...
import static com.tcs.destination.enums.JobStep.UTILISATION_UPLOAD_PROCESSING;
import static com.tcs.destination.enums.RequestStatus.VERIFIED;
import static com.tcs.destination.enums.RequestType.UTILISATION_UPLOAD;
...
@Component("utilisationUploadPreprocessor")
public class UtilisationUploadPreprocessor implements Tasklet {

	private static final Logger logger = LoggerFactory
			.getLogger(UtilisationUploadPreprocessor.class);
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		if (requestList == null) {
			requestList = dataProcessingRequestRepository.findByRequestTypeAndStatus(UTILISATION_UPLOAD.getType(), VERIFIED.getStatus());
		}
		...
		if (CollectionUtils.isNotEmpty(requestList)) {
		    ...
		    jobContext.put(NEXT_STEP, UTILISATION_UPLOAD_PROCESSING);

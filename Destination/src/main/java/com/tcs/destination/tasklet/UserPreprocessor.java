...
import static com.tcs.destination.enums.JobStep.USER_PROCESSING;
import static com.tcs.destination.enums.JobStep.END;
import static com.tcs.destination.enums.RequestStatus.VERIFIED;
import static com.tcs.destination.enums.RequestType.USER_UPLOAD;
...
@Component("userPreprocessor")
public class UserPreprocessor implements Tasklet{
	
	private static final Logger logger = LoggerFactory
			.getLogger(UserPreprocessor.class);
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		if (requestList == null) {
			requestList = dataProcessingRequestRepository.findByRequestTypeAndStatus(USER_UPLOAD.getType(), VERIFIED.getStatus());
		}
		...
		if (CollectionUtils.isNotEmpty(requestList)) {
		    ...
		    jobContext.put(NEXT_STEP, USER_PROCESSING);

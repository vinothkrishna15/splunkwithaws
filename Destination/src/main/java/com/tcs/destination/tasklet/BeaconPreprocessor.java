...
@Component("beaconPreprocessor")
public class BeaconPreprocessor implements Tasklet{
	
	private static final Logger logger = LoggerFactory
			.getLogger(BeaconPreprocessor.class);
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		if (requestList == null) {
			requestList = dataProcessingRequestRepository.findByRequestTypeAndStatus(BEACON_UPLOAD.getType(), VERIFIED.getStatus());
		}

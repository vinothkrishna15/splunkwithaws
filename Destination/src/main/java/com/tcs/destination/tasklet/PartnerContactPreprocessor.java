...
import static com.tcs.destination.enums.RequestType.PARTNER_CONTACT_UPLOAD;
...
@Component("partnerContactPreprocessor")
public class PartnerContactPreprocessor implements Tasklet{
	
	private static final Logger logger = LoggerFactory
			.getLogger(PartnerContactPreprocessor.class);
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		logger.info("Begin:Inside execute method of PartnerContactPreprocessor:");
		
		if (requestList == null) {
			requestList = dataProcessingRequestRepository.findByRequestTypeAndStatus(PARTNER_CONTACT_UPLOAD.getType(), VERIFIED.getStatus());
		}
		...
		logger.info("Exit:Inside execute method of PartnerContactPreprocessor:");

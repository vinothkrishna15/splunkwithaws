...
public interface CustomerRepository extends
    ...
    @Query(value = "SELECT * FROM customer_master_t "
			+ "WHERE UPPER(group_customer_name) LIKE UPPER(:term) "

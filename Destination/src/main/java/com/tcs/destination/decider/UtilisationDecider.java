...
public class UtilisationDecider implements JobExecutionDecider {

	private static final Logger logger = LoggerFactory
			.getLogger(UtilisationDecider.class);
	@Override
	public FlowExecutionStatus decide(JobExecution jobExecution,
		...
		if (jobExecution.getExecutionContext().get(NEXT_STEP).equals(JobStep.UTILISATION_UPLOAD_PROCESSING)) {
			status = new FlowExecutionStatus(JobStep.UTILISATION_UPLOAD_PROCESSING.name());

...
public class ProductsDwldDecider implements JobExecutionDecider {
	
	private static final Logger logger = LoggerFactory
			.getLogger(ProductsDwldDecider.class);
	...
	public FlowExecutionStatus decide(JobExecution jobExecution,
		...
		if (jobExecution.getExecutionContext().get(NEXT_STEP).equals(JobStep.PRODUCTS_DWLD_PROCESSING)) {
			status = new FlowExecutionStatus(JobStep.PRODUCTS_DWLD_PROCESSING.name());

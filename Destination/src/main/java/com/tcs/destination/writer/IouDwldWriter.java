...
public class IouDwldWriter implements ItemWriter<IouCustomerMappingT>,
		StepExecutionListener {

	private static final Logger logger = LoggerFactory
			.getLogger(IouDwldWriter.class);
	 ...
	 */
	@Override
	public void write(List<? extends IouCustomerMappingT> items) throws Exception {
		...
		if (rowCount == 1) {
			...
			sheet = workbook.getSheet(Constants.IOU_CUSTOMER_MAPPING_REF);
		}

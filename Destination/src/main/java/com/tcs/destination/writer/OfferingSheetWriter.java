...
public class OfferingSheetWriter implements ItemWriter<Object[]>,
		StepExecutionListener {

	private static final Logger logger = LoggerFactory
			.getLogger(OfferingSheetWriter.class);
	...
	/**
     * this method writes the sub sp and offering data in the offering sheet
     */
	@Override

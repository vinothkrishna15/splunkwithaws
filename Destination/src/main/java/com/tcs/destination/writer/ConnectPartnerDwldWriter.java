...
public class ConnectPartnerDwldWriter implements ItemWriter<Object[]>,
		StepExecutionListener {

	private static final Logger logger = LoggerFactory
			.getLogger(ConnectPartnerDwldWriter.class);
...
//	private OpportunityDownloadHelper opportunityDownloadHelper;
	...
	public void write(List<? extends Object[]> items) throws Exception {
		...
		if (rowCount == 1) {
			...
			sheet = workbook
					.getSheet(Constants.CONNECT_TEMPLATE_PARTNER_MASTER_SHEET_NAME);
		}

...
public class ConnectDwldGeoCountryWriter implements ItemWriter<GeographyCountryMappingT>,
		StepExecutionListener {

	private static final Logger logger = LoggerFactory
			.getLogger(ConnectDwldGeoCountryWriter.class);
	...
	public void write(List<? extends GeographyCountryMappingT> items) throws Exception {
		...
		if (rowCount == 1) {
			...
			sheet = workbook.getSheet(Constants.CONNECT_TEMPLATE_GEOGRAPHY_COUNTRY_SHEET_NAME);
		}

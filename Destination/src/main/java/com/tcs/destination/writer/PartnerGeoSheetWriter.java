...
public class PartnerGeoSheetWriter implements ItemWriter<Object[]>,
		StepExecutionListener {

	private static final Logger logger = LoggerFactory
			.getLogger(PartnerGeoSheetWriter.class);
	...
	public ExitStatus afterStep(StepExecution stepExecution) {
		logger.debug("Inside after method of partner geo download writer");
	...
	/**
     * this method writes the geography and country in the Geography Country sheet
     */
	@Override

...
public class UserDwldTimezoneWriter implements ItemWriter<TimeZoneMappingT>,
		StepExecutionListener {

	private static final Logger logger = LoggerFactory
			.getLogger(UserDwldTimezoneWriter.class);
	...
	public void write(List<? extends TimeZoneMappingT> items) throws Exception {
		...
		if (rowCount == 1) {
			...
			sheet = workbook.getSheet(Constants.USER_TEMPLATE_TIMEZONE);
		}

...
public class UserDwldIouUniqWriter implements ItemWriter<Object>,
		StepExecutionListener {

	private static final Logger logger = LoggerFactory
			.getLogger(UserDwldIouUniqWriter.class);
	...
	public void write(List<? extends Object> items) throws Exception {
		...
		if(items!=null) {
			for (Object displayIou : items) {
				// Create row with rowCount
				Row row = sheet.getRow(rowCount);
				ExcelUtils.createCell((String)displayIou,row,5);

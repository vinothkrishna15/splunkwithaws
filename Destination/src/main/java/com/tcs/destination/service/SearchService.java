...
public class SearchService {
	...
	public List<CustPartResultCard> searchforCustPartDetail(String chars) {
		List<CustPartResultCard> searchResults = new ArrayList<CustPartResultCard>();
	...
	private void ajaxSearchForPartnerContaining(String chars,
		...
		for (PartnerMasterT partner : partners) {
			...
			search.setEntityType(Constants.EntityType.PARTNER.toString());
	...
	private List<SearchCusPartAjax> ajaxSearchForCustContaining(String chars) {
		...
		for (CustomerMasterT customer : customers) {
			SearchCusPartAjax search = new SearchCusPartAjax();
			search.setEntityType(Constants.EntityType.CUSTOMER.toString());

...
public enum RequestType {
	...
	PRODUCT_UPLOAD(20,EntityType.PRODUCT,Constants.PRODUCT_UPLOAD_SUBJECT,Constants.PRODUCT_UPLOAD_NOTIFY_SUBJECT),
	PRODUCT_DOWNLOAD(21,EntityType.PRODUCT,Constants.PRODUCT_DOWNLOAD_SUBJECT),
	PRODUCT_CONTACT_UPLOAD(22,EntityType.PRODUCT_CONTACT,Constants.PRODUCT_CONTACT_UPLOAD_SUBJECT,Constants.PRODUCT_CONTACT_UPLOAD_NOTIFY_SUBJECT),
	PRODUCT_CONTACT_DOWNLOAD(23,EntityType.PRODUCT_CONTACT,Constants.PRODUCT_CONTACT_DOWNLOAD_SUBJECT),
	PARTNER_MASTER_UPLOAD(24,EntityType.PARTNER_MASTER,Constants.PARTNER_MASTER_UPLOAD_SUBJECT,Constants.PARTNER_UPLOAD_NOTIFY_SUBJECT),
	PARTNER_MASTER_DOWNLOAD(25,EntityType.PARTNER_MASTER,Constants.PARTNER_MASTER_DOWNLOAD_SUBJECT), 
	RGS_UPLOAD(26,EntityType.RGS,Constants.RGS_UPLOAD_SUBJECT,Constants.RGS_UPLOAD_NOTIFY_SUBJECT),
	RGS_DOWNLOAD(27,EntityType.RGS,Constants.RGS_DOWNLOAD_SUBJECT),
	UTILISATION_UPLOAD(28,EntityType.DELIVERY_CENTRE_UTILIZATION,Constants.UTILIZATION_UPLOAD_SUBJECT,Constants.UTILIZATION_UPLOAD_NOTIFY_SUBJECT),
	UNALLOCATION_UPLOAD(29,EntityType.DELIVERY_CENTRE_UNALLOCATION,Constants.UNALLOCATION_UPLOAD_SUBJECT,Constants.UNALLOCATION_UPLOAD_NOTIFY_SUBJECT),
	CUSTOMER_ASSOCIATE_UPLOAD(30,EntityType.CUSTOMER_ASSOCIATE,Constants.CUSTOMER_ASSOCIATE_UPLOAD_SUBJECT,Constants.CUSTOMER_ASSOCIATE_UPLOAD_NOTIFY_SUBJECT);
